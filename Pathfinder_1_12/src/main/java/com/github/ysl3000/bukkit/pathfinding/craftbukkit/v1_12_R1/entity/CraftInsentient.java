...
public class CraftInsentient implements Insentient {
  ...
  @Override
  public void addPathfinderGoal(int priority,
  ...
  @Override
  public void removePathfinderGoal(
      com.github.ysl3000.bukkit.pathfinding.pathfinding.PathfinderGoal pathfinderGoal) {
  ...
  @Override
  public boolean hasPathfinderGoal(
      com.github.ysl3000.bukkit.pathfinding.pathfinding.PathfinderGoal pathfinderGoal) {
  ...
  @Override
  public void addTargetPathfinderGoal(int priority,
      com.github.ysl3000.bukkit.pathfinding.pathfinding.PathfinderGoal pathfinderGoal) {
    CraftPathfinderGoalWrapper goalWrapper = new CraftPathfinderGoalWrapper(pathfinderGoal);
  ...
  @Override
  public void removeTargetPathfinderGoal(
      com.github.ysl3000.bukkit.pathfinding.pathfinding.PathfinderGoal pathfinderGoal) {
  ...
  @Override
  public boolean hasTargetPathfinderGoal(
      com.github.ysl3000.bukkit.pathfinding.pathfinding.PathfinderGoal pathfinderGoal) {
  ...
  public void lookAt(Location location) {
    handle.getControllerLook()
        .a(location.getX(), location.getY(), location.getZ(), location.getYaw(),
            location.getPitch());
  }
  ...
  public Location getLookingAt() {
    ...
    return new Location(handle.getBukkitEntity().getWorld(), controllerLook.e(), controllerLook.f(),
        controllerLook.g());
  }
  ...
  private class GoalSelector implements
      com.github.ysl3000.bukkit.pathfinding.pathfinding.PathfinderGoalSelector {
    ...
    @Override
    public void addPathfinderGoal(int priority,
        com.github.ysl3000.bukkit.pathfinding.pathfinding.PathfinderGoal goal) {
  ...
  private class TargetGoalSelector implements
      com.github.ysl3000.bukkit.pathfinding.pathfinding.PathfinderGoalSelector {
  ...
  private class ControllerJump implements
      com.github.ysl3000.bukkit.pathfinding.pathfinding.ControllerJump {
  ...
  private class ControllerMove implements
      com.github.ysl3000.bukkit.pathfinding.pathfinding.ControllerMove {

    @Override
    public boolean isOperationMove() {
      return handle.getControllerMove().h
          == net.minecraft.server.v1_12_R1.ControllerMove.Operation.MOVE_TO;
    }
  ...
  private class ControllerLookImpl implements
      com.github.ysl3000.bukkit.pathfinding.pathfinding.ControllerLook {
    ...
    public void lookAt(double x, double y, double z, float yaw, float pitch) {
      CraftInsentient.this
          .lookAt(new Location(handle.getBukkitEntity().getWorld(), x, y, z, yaw, pitch));
    }
