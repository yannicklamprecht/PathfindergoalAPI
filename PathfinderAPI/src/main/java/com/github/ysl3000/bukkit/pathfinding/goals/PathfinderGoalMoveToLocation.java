...
public class PathfinderGoalMoveToLocation implements PathfinderGoal {
    ...
    public PathfinderGoalMoveToLocation(Insentient pathfinderGoalEntity, Location targetLocation, double walkSpeed, double distance) {
    ...
    public boolean shouldExecute() {
        ...
        return pathfinderGoalEntity.getBukkitEntity().getLocation().distanceSquared(targetLocation) > distance;
    }
    ...
    public void execute() {
        if (pathfinderGoalEntity.getBukkitEntity().getLocation().
                add(pathfinderGoalEntity.getBukkitEntity().getLocation().getDirection().normalize()).getBlock().getType() != Material.AIR) {
